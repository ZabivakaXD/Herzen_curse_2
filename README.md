...
[Лабораторная работа №1 по теме "Начало работы с MySQL. MySQL Workbench"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/lab-1_sem-4.md)

[Лабораторная работа №2 по теме "Схема данных. EER-диаграмма"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/lab-2_sem-4.md)

[Лабораторная работа №3 по теме "Решение задач реляционной алгебры 1 часть"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/lab-3_sem-4.md)

[Лабораторная работа №4 по теме "Решение задач реляционной алгебры 2 часть"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/lab-4_sem-4.md)

[Лабораторная работа №5 по теме "Проектирование реляционной базы данных на основе исходного набора информации,нормализация которой соответствует НФБК."](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/lab-5_sem-4.md)

### Самостоятельные работы

[Самостоятельная работа №1 по теме "Обобщенная архитектура баз данных"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/SR-1_sem-4.md)

[Самостоятельная работа №2 по теме "Этапы проектирования БД. Модели данных"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/SR-2_sem-4.md)

[Самостоятельная работа №3 по теме "Реляционная модель данных: допустимые структуры, ограничения и операции реляционной алгебры"](https://github.com/ZabivakaXD/Herzen_curse_2/blob/main/DB/SR-3_sem-4.md)
